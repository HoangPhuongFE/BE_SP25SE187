...
router.get(
  '/',
  authenticateToken,
  checkRole(['admin', 'academic_officer',"graduation_thesis_manager", "examination_officer",'mentor','lecturer'], false),
...
router.post(
  '/',
  authenticateToken,
  checkRole(['admin','academic_officer',"graduation_thesis_manager", "examination_officer"], false),
