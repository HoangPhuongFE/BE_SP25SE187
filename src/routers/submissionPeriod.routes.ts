...
router.get("/semester/:semesterId", authenticateToken, checkRole(["graduation_thesis_manager", "examination_officer",'lecturer']), controller.getSubmissionPeriods.bind(controller));
router.get("/:periodId", authenticateToken,checkRole(["graduation_thesis_manager", "examination_officer",'lecturer']), controller.getSubmissionPeriodById.bind(controller));
